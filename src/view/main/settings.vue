    ...
    <v-container id="home-content">
        ...
        <v-container>
            <v-card>
                ...
                <v-divider />
                <v-form ref="profileForm" class="input-form">
                    <v-text-field
            ...
            <v-card>
                ...
                <v-divider />
                <v-form ref="passwordForm" class="input-form">
                    <v-text-field
            ...
            <v-card>
                <v-list-item>
                    <v-list-item-content>
                        <v-list-item-title id="delete-title">Delete Account</v-list-item-title>
                    </v-list-item-content>
                </v-list-item>
                <v-divider />
        ...
        <v-dialog v-model="passwordErrorDialog" persistent max-width="500">
...
export default {
    ...
    methods: {
        ...
        getUser: function(){
            ...
            .then(res => {
                this.Loading = false
                this.profile.user_id = res.data.data.user_id
